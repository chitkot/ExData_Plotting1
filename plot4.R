...
with(feb2007, {
  ...
  plot(feb2007$datetime,feb2007$Global_active_power, type="l", xlab = "", ylab = "Global Active Power")
  
  # Plot2:, row 1 column 2
  plot(feb2007$datetime,feb2007$Voltage, type="l", xlab = "", ylab = "Voltage")
  ...
  plot(feb2007$datetime, feb2007$Sub_metering_1, type="l", xlab = "", ylab = "Energy sub meterin g", 
      ...
      # Superimpose submetering 2 on submetering 1
      par(new = TRUE) 
      plot(feb2007$datetime, feb2007$Sub_metering_2, type="l", col="red", xlab = "", ylab = "", 
          ylim=range(feb2007$Sub_metering_1)) 
      # Superimpose submetering 3 on sub metering 1 and 2
      par(new = TRUE) 
      plot(feb2007$datetime, feb2007$Sub_metering_3, type="l", col="blue", xlab = "", ylab = "", 
          ylim=range(feb2007$Sub_metering_1)) 
      # Add legend to the plot
      legend("topright", pch = "-", col = c("black","red","blue"), bty = "n", cex = 1, pt.cex = 1,
         yjust = 1, legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"))
  
  # Plot4: row2 column2
  plot(feb2007$datetime,feb2007$Global_reactive_power, type="l", 
       xlab = "datetime", ylab = "Global_reactive_power", ylim=range(feb2007$Global_reactive_power))
